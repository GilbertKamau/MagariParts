                            ...
                            <div key={product?._id+"Add To Cart Loading"} className='w-full bg-white h-32 my-2 border border-slate-300  rounded grid grid-cols-[128px,1fr]'>
                                ...
                                <div className='px-4 py-2 relative'>
                                    ...
                                    <div className='flex items-center justify-between'>
                                            <p className='text-red-600 font-medium text-lg'>{displayKESCurrency(product?.productId?.sellingPrice)}</p>
                                            <p className='text-slate-600 font-semibold text-lg'>{displayKESCurrency(product?.productId?.sellingPrice  * product?.quantity)}</p>
                                    </div>
